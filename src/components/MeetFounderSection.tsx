      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl glass-panel p-8 sm:p-14 border border-white/10 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Real Image */}
            <div className="lg:col-span-5 relative h-[380px] sm:h-[450px] rounded-2xl overflow-hidden border border-white/15 shadow-2xl">
              <img
                src="/portfolio/akhir-chaudhary-studio-vision.jpg"
                alt="Akhir Chaudhary - Founder & Principal Architectural Director"
              ...
              <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-[#050505]/80 backdrop-blur-md border border-white/10">
                ...
                <p className="text-[#D4AF37] text-xs font-medium">Design. Build. Inspire.</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div>
                ...
                <p className="text-[#D4AF37] text-sm font-medium">
                  Founder &amp; Principal Architectural Director
                </p>
              </div>

              <p className="text-[#A1A1AA] text-sm leading-relaxed font-light">
                With over 12+ years of hands-on architectural design and turnkey project execution across Mumbai, Akhir Chaudhary personally leads every project from conceptual space planning to site handover with an obsession for spatial proportions, tactile materials, and honest craftsmanship.
              </p>
              ...
              <div className="space-y-3 text-xs text-white">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-[#121212] border border-white/10">
                  ...
                  <span>Personal leadership on 50+ luxury handovers across Bandra, Worli, Juhu &amp; South Mumbai</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl bg-[#121212] border border-white/10">
